namespace PetCare.Data.Migrations
{
    ...
    [Migration("20210728132222_UserNickNameColumn")]
    partial class UserNickNameColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetCare.Data.Models.Clinic.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PetCare.Data.Models.Clinic.Clinic", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PetCare.Data.Models.Pet.Animal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PetCare.Data.Models.User.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PetCare.Data.Models.VetService.VetService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PetCare.Data.Models.User.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PetCare.Data.Models.Clinic.Clinic", b =>
                {
                    b.HasOne("PetCare.Data.Models.Clinic.City", "City")
                        .WithMany("Clinics")
            ...
            modelBuilder.Entity("PetCare.Data.Models.Pet.Pet", b =>
                {
                    b.HasOne("PetCare.Data.Models.Pet.Animal", "Animal")
                        .WithMany("Pets")
